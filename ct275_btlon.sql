...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 26, 2022 lúc 03:37 AM
...
(3, 'Readme-7i', 48, 'realme-7i.jpg', 3000000, 2900000, 'Tiếp nối bộ đôi đình đám Realme 7 và Realme 7 Pro, Realme đã cho ra mắt thêm thành viên mới Realme 7i với một mức giá hấp dẫn hơn. Máy vẫn giữ lại những thông số ấn tượng như màn hình 90 Hz đi kèm hiệu năng từ Snapdragon 662 cho trải nghiệm mượt mà và ổn định. ', 1),
...
(5, 'Vivo-Y21', 100, 'vivo-y21.jpg', 10000000, 8500000, 'Máy có một thiết kế nguyên khối tạo cảm giác bền bỉ, chắc chắn. Vivo Y21 còn mang đến trải nghiệm cầm nắm thoải mái với thân máy mỏng chỉ 8 mm và có các cạnh viền bo tròn mịn màng giúp cho mọi thao tác sử dụng trở nên hoàn hảo.\r\n\r\n\r\n', 1),
...
(16, 'Iphone-6-Se', 60, 'iphone-6Se.png', 6000000, 5900000, 'iPhone SE 64 GB (2022) vẫn không thay đổi thiết kế nhiều so với phiên bản tiền nhiệm. Máy vẫn có màn hình 4.7 inch, viền màn hình trên và dưới được giữ lại để chứa camera selfie và nút Home “huyền thoại\". Màn hình iPhone SE 64 GB (2022) sẽ sử dụng tấm nền IPS LCD, cho chất lượng hiển thị khá tốt.', 1),
(17, 'Iphone-11-Promax', 100, 'iphone-11Promax.png', 18000000, 17000000, 'Apple đã chính thức trình làng bộ 3 siêu phẩm iPhone 11, trong đó phiên bản iPhone 11 64GB có mức giá rẻ nhất nhưng vẫn được nâng cấp mạnh mẽ như iPhone Xr ra mắt trước đó.', 1),
(18, 'Iphone-12-Promax', 100, 'iphone-12Promax.jpg', 32000000, 31000000, 'iPhone 12 Mini sở hữu thiết kế vuông vức, thay vì các cạnh tròn như trên những chiếc iPhone gần đây, các cạnh được vát phẳng tương tự iPhone 4, iPhone 5 đình đám một thời.', 1),
(19, 'Oppo-Revo-6', 100, 'oppo-revo-6.jpg', 85000000, 17000000, 'Điện thoại OPPO Reno7 Z 5G có khung viền vát phẳng, vuông vức trendy làm cho máy toát lên nét hiện đại và năng động. Bốn góc được bo cong mềm mại tạo cảm giác thoải mái và nhẹ nhàng (chỉ 173 g). Với thiết kế nguyên khối làm tổng thể máy trở nên cực kỳ chắc chắn, không chỉ đẹp mà còn tăng độ bền.', 1),
...
(25, 'op-lung-cute-khunglong', 100, 'op-lung-cute-khunglong.jpg', 35000, 34000, 'Kiểu dáng tối giản, sang trọng với gam dịu dàng, nhã nhặn.\r\nThiết kế thích hợp cho mẫu điện thoại thông tin.\r\nSử dụng chất liệu nhựa dẻo chất lượng tốt, chịu lực, dễ uốn cong. \r\nThao tác tách rời và lắp ốp vào máy nhanh nhẹn, không tốn sức.', 2),
(26, 'Ốp-lung-trai-tim', 100, 'op-lung-trai-tim.jpg', 39000, 38000, 'Kiểu dáng tối giản, sang trọng với gam dịu dàng, nhã nhặn.\r\nThiết kế thích hợp cho mẫu điện thoại thông tin.\r\nSử dụng chất liệu nhựa dẻo chất lượng tốt, chịu lực, dễ uốn cong. \r\nThao tác tách rời và lắp ốp vào máy nhanh nhẹn, không tốn sức.', 2);
...
(3, 'Nguyễn Minh Kiên', 'Kienb1809373@student.ctu.edu.vn', '123456', '0765962393', 'An Giang'),
(4, 'Nguyễn Minh Kiên', 'minhb18093723@student.ctu.edu.vn', '123456', '0765962393', 'Cần Thơ'),
(5, 'Trương Hoàng Long', 'satoh95@gmail.com', 'VktP9PHe', '0853475348', 'An Giang');
