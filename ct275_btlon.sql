...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 26, 2022 lúc 04:32 PM
...
(3, 'Realme 7i', 48, 'realme-7i.jpg', 3000000, 2900000, 'Tiếp nối bộ đôi đình đám Realme 7 và Realme 7 Pro, Realme đã cho ra mắt thêm thành viên mới Realme 7i với một mức giá hấp dẫn hơn. Máy vẫn giữ lại những thông số ấn tượng như màn hình 90 Hz đi kèm hiệu năng từ Snapdragon 662 cho trải nghiệm mượt mà và ổn định. ', 1),
